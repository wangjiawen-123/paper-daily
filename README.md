...
看不到 New issue 是因为**==fork的仓库默认不显示Issues，需要手动开启==**

**Settings -->就在General这个界面往下滑有 Features --> 勾选 ✅ Issues**

![image-20260630161037557](Typora_Notes_Photo/image-20260630161037557.png)
...
## 第 4 步：配置模型 API Key！！！！翻译主要看这一步！！ ==（写完issue跳转到这一步）==
